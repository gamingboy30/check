...
<div class="card col-sm-8">
  <h5 class="card-body h6">💎☮YourName😎👹</h5>
  <div class="card-body">
    <center><span>💎☮YourName😎👹</span></center>
<div class="md-form">
	<div class="col-md-12">
...
<center>
 <button class="btn btn-primary" style="width: 250px; outline: none;" id="testar" onclick="enviar()" >TEST</button>
  <button class="btn btn-danger" style="width: 250px; outline: none;">STOP</button>
</center>
  </div>
</div>
...
<div class="card col-sm-2">
  ...
  <div class="card-body">
  	<span>Status:</span><span class="badge badge-secondary"> Processing.</span>
<div class="md-form">
...
<footer >
    ...
    <div class="footer-copyright text-center py-3">🐉YourName🐉
